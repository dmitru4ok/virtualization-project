...
psql -h 127.0.0.1 -U postgres -d closednebula -c "CREATE TABLE IF NOT EXISTS users (login VARCHAR(255), password VARCHAR(255));"
psql -h 127.0.0.1 -U postgres -d closednebula -c "CREATE TABLE IF NOT EXISTS vms (user_login VARCHAR(255), open_nebula_id Integer);"
